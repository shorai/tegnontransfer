...
// NB DateTimeStamp is a reserved word in SQL 92  MS SQL should NEVER allow it tio be used as a column name
    ...
    Integer id;
    Integer sensorStatusTID;
    String sensorStatusName;
    String description;
    ...
    void bind(ResultSet rs) throws SQLException {
        ...
        id = rs.getInt(i++);
        sensorStatusTID = rs.getInt(i++);
        sensorStatusName = rs.getString(i++);
        description = rs.getString(i++);
    }

    int update() throws SQLException {
        int i = 1;
       updateStatement.setInt(i++,sensorStatusTID);
       
        updateStatement.setString(i++, sensorStatusName);
    ...
    void insert() throws SQLException {
        ...
        updateStatement.setInt(i++,sensorStatusTID);
        insertStatement.setString(i++, sensorStatusName);
    ...
    void transfer(Connection in, Connection out) {
        ...
        try {
            ...
            System.out.println("Transfer SensorStatus  Failed  after processing  " + count 
                    + " records, inserts = " + numInserts 
                    + " Updates="+numUpdates 
                    + "   Exception:" + sexc.getLocalizedMessage());
